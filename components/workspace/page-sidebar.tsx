...
export function PageSidebar({
  ...
  return (
    <aside className="relative z-[1] flex w-[18rem] md:w-[20rem] shrink-0 flex-col border-r border-[var(--glass-border)] bg-[var(--surface-mid)] p-4 shadow-[12px_0_48px_-12px_rgba(0,0,0,0.5)]">
      ...
      <nav className="flex min-h-0 flex-1 flex-col gap-1 overflow-y-auto" aria-label="Pages">
        <div className="mb-4 flex flex-col gap-1">
          <Link href="/app/board" className={`glass-nav-item border border-violet-500/15 shadow-[0_0_8px_rgba(139,92,246,0.06)] hover:bg-violet-500/10 ${pathname === "/app/board" ? "bg-violet-500/20 text-white shadow-inner" : ""}`}>
      ...
      <div className="mt-auto pt-4 pb-1">
        <Link href="/app/members" className={`glass-nav-item mb-4 border border-amber-500/15 shadow-[0_0_8px_rgba(245,158,11,0.06)] hover:bg-amber-500/10 ${pathname === "/app/members" ? "bg-amber-500/20 text-white shadow-inner" : ""}`}>
